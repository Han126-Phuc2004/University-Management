...
public class DBConnection {
    private static final String URL = "jdbc:sqlserver://THAONGUYENN\\SQLEXPRESS:1433;databaseName=university_management;encrypt=false;trustServerCertificate=true";
