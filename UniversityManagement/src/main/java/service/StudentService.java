...
//=== THÊM SINH VIÊN MỚI ===
    ...
    public void addStudent() {
        ...
        Student student = new Student(fullName, dateOfBirth, gender, phone, email,
    ...
    public void updateStudent() {
        ...
        int studentId = getValidStudentId("Nhập mã sinh viên cần cập nhật (0 để hủy): ");
    ...
    private int getValidStudentId(String prompt) {
        while (true) {
    ...
    public void deleteStudent() {
        ...
        int studentId = getValidStudentId("Nhập mã sinh viên cần xóa (0 để hủy): ");
        if (studentId == 0) return;
    ...
    public void viewStudent() {
        ...
        int studentId = getValidStudentId("Nhập mã sinh viên cần xem (0 để hủy): ");
        if (studentId == 0) return;
    ...
    public void listAllStudents() {
        ...
        if (students.isEmpty()) {
            ...
            for (Student student : students) {
                System.out.printf("%-10d %-30s %-15s %-10s %-15s %-30s %-10s %-15s %-5.2f%n",
