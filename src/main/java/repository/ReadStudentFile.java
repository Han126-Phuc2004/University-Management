...
public class ReadStudentFile {
    ...
    private static String mapDepartment(String depCode) {
        ...
        switch (depCode.trim().toUpperCase()) {
            ...
            case "AI":
                return "AI";
            case "IB":
                return "IB"; // BA -> IB trong database
            case "IT":
                return "IT";
            default:
                return null;
    ...
    public static List<Student> parseStudents(List<String[]> csvData) {
        ...
        for (String[] cols : csvData) {
            ...
            int studentId = FileUtils.extractDigitsToInt(stuCode); // "DE180106" -> 180106 (không dùng)
    ...
    public static void main(String[] args) {
        String filePath = System.getProperty("user.dir") + "/data/students.csv";
        List<Student> students = loadStudents(filePath);
        new StudentRepository().saveStudentFromCSVToBD(filePath);
