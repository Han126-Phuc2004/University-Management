    ...
    public class DBConnection {
        private static final String URL = "jdbc:sqlserver://localhost:1433;databaseName=university_management;encrypt=true;trustServerCertificate=true";
        ...
        static{
            try{
                ...
                System.out.println("Lỗi khi tải driver: " + e.getMessage());
            }
        }
